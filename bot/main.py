...
async def start(bot, message):
  ...
  await message.reply_photo("https://telegra.ph/file/986bc6640b9bbce71ad15.jpg",caption=START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"), InlineKeyboardButton(text="Repo", url="https://github.com/TechShreyash/TechZ-Logo-Maker-Bot")]]))

@app.on_message(filters.command("help"))

async def help(bot, message):

  await message.reply_photo("https://telegra.ph/file/986bc6640b9bbce71ad15.jpg",caption=HELP,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Back", callback_data="start_menu")]]))
...
async def logo(bot, message):
  ...
  try:
    ...
    text = message.text.replace("logo","").replace("/","").replace("@wisula4","").strip().upper()
